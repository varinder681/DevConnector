...
const AddEducation = ({addEducation, history}) => {
  ...
  return (
    <React.Fragment>
      ...
      <p className="lead">
        <i className="fas fa-code-branch"></i> Add any school or University/College
      </p>
      ...
      <form className="form"onSubmit={ e => {
        ...
        <div className="form-group">
          <input type="text" placeholder="* School/University/College" name="school" value={school} onChange={e => onChange(e)} required />
        </div>
        <div className="form-group">
